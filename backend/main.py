...
async def analyze_repository(repo_url: str, job_id: str):
    ...
    try: 
        ...
        content_summary = ""
        # Valitaan tiedostot, jotka kertovat eniten teknologiasta
        target_files = ["package.json", "requirements.txt", "Dockerfile", "README.md", "index.html"]
            ...
            if file_path.exists():
                try:
                    with open(file_path, "r", encoding="utf-8") as f:
                        # Luetaan max 2000 merkkiä per tiedosto, ettei prompti paisu liikaa
